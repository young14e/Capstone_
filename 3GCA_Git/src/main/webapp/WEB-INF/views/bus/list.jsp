...
<div class="container">
	...
	<div>
		<table class="table table-striped table-bordered table-hover">
			...
			<c:forEach items="${list}" var="bus">
				<tr>
					<td><c:out value="${bus.bno}" /></td>
					<td>
						<a class='move' href='<c:out value="${bus.bno}"/>'>
							<c:out value="${bus.title}" />
						</a>
					</td>
					<td><c:out value="${bus.departarea}" /></td>
					<td><c:out value="${bus.recruitnum}" /> / <c:out value="${bus.maxrecruitnum}" /></td>
					<td><fmt:formatDate pattern="yyyy-MM-dd"
							value="${bus.deadline}" /></td>
				</tr>
			</c:forEach>
		</table>
		...
		<div>
			<div style="float: right;">
				<form class="form-inline" id='searchForm' action="/bus/list"
					method='get'>
	...
	<form id='actionForm' action="/bus/list" method='get'>
